...
mixin _$AuthState {
  ...
  Result when<Result extends Object>({
    ...
    @required Result athenticated(),
    @required Result unathenticated(),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    Result initial(),
    Result athenticated(),
    Result unathenticated(),
    @required Result orElse(),
  });
  @optionalTypeArgs
  Result map<Result extends Object>({
    @required Result initial(Initial value),
    @required Result athenticated(Authenticated value),
    @required Result unathenticated(Unauthenticated value),
  });
  @optionalTypeArgs
  Result maybeMap<Result extends Object>({
    Result initial(Initial value),
    Result athenticated(Authenticated value),
    Result unathenticated(Unauthenticated value),
    @required Result orElse(),
  });
}
